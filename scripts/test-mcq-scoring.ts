...
async function runTests() {
  // Test 1: All correct selections
  {
    ...
    const result = await scoreMultipleChoiceAnswer(mcqQuestion, answers)
  ...
  // Test 5: All or nothing mode - exact match
  {
    ...
    const result = await scoreMultipleChoiceAnswer(allOrNothingQuestion, answers)
  ...
  // Test 8: Question with points on segments instead of maxPoints
  {
    ...
    const result = await scoreMultipleChoiceAnswer(segmentPointsQuestion, answers)
