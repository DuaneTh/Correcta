...
export default function StudentLayoutClient({ children, dictionary, currentLocale }: StudentLayoutClientProps) {
    const pathname = usePathname()

    const navLinks = [
        { href: '/student/courses', label: dictionary.student.header.myCourses },
        { href: '/student/exams', label: dictionary.student.header.exams },
        { href: '/student/next-exam', label: dictionary.student.header.nextExam },
    ]
